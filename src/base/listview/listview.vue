  ...
  export default{
    ...
    methods: {
      ...
      onShortcutTouchStart(e) {
        ...
        let firstTouch = e.touches[0] // 手指触摸下touchlist
        this.touch.y1 = firstTouch.pageY
        this.touch.anchorIndex = anchorIndex
        this.scrollTo(anchorIndex)
      },
      onShortcutTouchMove(e) {
        let firstTouch = e.touches[0] // 结束是的touchlist
        this.touch.y2 = firstTouch.pageY
        let delta = parseInt(this.touch.y2 - this.touch.y1) / ANCHOR_LENGTH | 0
    ...
    watch: {
      ...
      diff(newVal) {
        let fixedTop = (newVal > 0 && newVal < ANCHOR_HEIGHT) ? newVal - ANCHOR_HEIGHT : 0
